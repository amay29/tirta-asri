...
export default function RiwayatDanaMasuk() {
  ...
  if (!user || loadingData) return (
    <div style={{ padding: '28px 16px', maxWidth: '600px', margin: '0 auto' }}>
  ...
  return (
    <div style={{ padding: '28px 16px 48px', maxWidth: '600px', margin: '0 auto' }}>
      ...
      <div className="stat-card stat-card-dark animate-fade-up delay-1" style={{ marginBottom: '16px' }}>
        <p className="stat-label" style={{ color: '#5a9e8a' }}>
          <i className="ri-funds-line" /> Total Iuran Masuk
        </p>
